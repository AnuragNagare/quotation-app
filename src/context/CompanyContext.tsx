...
import { listMyCompanies, createCompany as createCompanyApi } from "@/lib/companies";
import type { Company } from "@/types/database";

const ACTIVE_COMPANY_STORAGE_KEY = "roxy_active_company_id";
...
export function CompanyProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <CompanyContext.Provider
      value={{ companies, activeCompany, setActiveCompanyId, loading, refresh, createCompany }}
    >
      {children}
    </CompanyContext.Provider>
  );
